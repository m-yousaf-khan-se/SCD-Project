...
public class ApplicationMain extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        //Setting up MVP
        //------------------------------------------------------------------
        IModel model = new DiagramModel(); /* @Saad is ki jaga dakh lena tum na kon kon sa model kis presenter ma use kerna hai
                                                wo wo model define ker k relavent Presetner ma pass ker dena*/

        while(true)
        {
            if (parentView != null) {
                ClassDiagramPresenter classDiagramPresenter = new ClassDiagramPresenter(model ,parentView);
