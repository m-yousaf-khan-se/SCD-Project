...
public class GeneralizationIController  extends ViewIController implements IController, IClassComponentController {
...
//            }
    ...
    private void updateAttachedClass(Circle corner, Node node) {
        ...
        if (corner == corner1) {
            ...
            updateGeneratlization(className1, newClassName, className2, className2);
            ...
            newClassName = ctrl.getUMLClassName();
            updateGeneratlization(className1, className1, className2, newClassName);
    ...
    public Double[] getCoordinates() {
        ...
        classCoordinates[0] = generalizationGroup.getLayoutX();
        classCoordinates[1] = generalizationGroup.getLayoutY();
